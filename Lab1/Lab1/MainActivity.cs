...
namespace Lab1
{
    ...
    public class MainActivity : Activity
    {
        ...
        {
            textViewDev.Text = "José Rafael Méndez García";
            
            string myDevice = Android.Provider.Settings.Secure.GetString(ContentResolver, Android.Provider.Settings.Secure.AndroidId);
            XamarinDiplomado.ServiceHelper helper = new XamarinDiplomado.ServiceHelper();
            await helper.InsertarEntidad("fayo2410@hotmail.com", "Lab1", myDevice);
            button.Text = "Gracias por completar el Lab 1" + myDevice;
